...
export function Sidebar() {
  ...
  const getListTaskCount = (listId: string) => allTasks.filter(t => !t.done && t.listId === listId).length;
        ...
        <nav className="flex-1 overflow-y-auto px-2 py-3">
          ...
          <div className="mt-4">
            <div className="flex items-center justify-between px-3 mb-1">
              <span className="text-[10px] font-medium uppercase tracking-wider text-[var(--fg-quieter)]">
                {t('nav.lists')}
              </span>
              <button
